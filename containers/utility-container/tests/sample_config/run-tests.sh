...
COVERAGE_ARGS=(--configuration /var/www/drupal/tests/config/phpunit.xml.dist --coverage-clover /var/www/drupal/tests/coverage-report/clover.xml --log-junit /var/www/drupal/tests/coverage-report/junit.xml --coverage-php /var/www/drupal/tests/coverage/phpunit.cov)
